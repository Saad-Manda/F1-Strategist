...
This is hard because tires degrade non-linearly (the "cliff" — a sudden, dramatic grip loss), safety cars are unpredictable, and the optimal strategy depends on what rivals are doing. PitGenius models this as a Markov Decision Process and trains RL agents to solve it.
